"""indian_tiktok_24908 URL Configuration
...
admin.site.site_header = "Indian Tiktok"
admin.site.site_title = "Indian Tiktok Admin Portal"
admin.site.index_title = "Indian Tiktok Admin"

# swagger
api_info = openapi.Info(
    title="Indian Tiktok API",
    default_version="v1",
    description="API documentation for Indian Tiktok App",
)
